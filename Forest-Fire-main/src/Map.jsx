            ...
            <Popup className="popup"
              ...
              <div style={{ display: 'flex', flexDirection: 'row' }}>
                <div style={{widht:'20vh', height:'20vh', justifyContent: "center"}}>
                  Hour 1
                  <SimpleMap locations = {files} start = {startingLoc}/>
                </div>
                <div>
                  Hour 2
                  <SimpleMap locations = {files2} start = {startingLoc}/>
                </div>
                <div>
                  Hour 3
                  <SimpleMap locations = {files3} start = {startingLoc}/>
                </div>
                <div>
                  Hour 4
                  <SimpleMap locations = {files4} start = {startingLoc}/>
                </div>
                <div>
                  Hour 5
                  <SimpleMap locations = {files5} start = {startingLoc}/>
                </div>
              </div>
              </>}
